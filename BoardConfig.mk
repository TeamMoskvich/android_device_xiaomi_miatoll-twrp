...
# msm_rtb.filter=0x237 service_locator.enable=1 swiotlb=1
...
# MIUI Crypto
BOARD_AVB_RECOVERY_ADD_HASH_FOOTER_ARGS += --prop com.android.build.boot.security_patch:$(PLATFORM_SECURITY_PATCH)
...
# Dynamic Partition
BOARD_SUPER_PARTITION_SIZE := 8585740288
